...
exports['regexp.match.utf8.no_study'] = function(test)
  local cs = require('cornerstone')
  local regexp = cs.utf8.regexp
  local re = regexp.compile('..', nil, nil)
  local mr = re:match('\227\129\130\227\129\132')
  test.ok(mr)
  test.equal(mr:captureCount(), 0)
  test.equal(mr:first(0), 1)
...
exports['regexp.match.utf8.no_jit'] = function(test)
  local cs = require('cornerstone')
  local regexp = cs.utf8.regexp
  local re = regexp.compile('..', nil, 0)
  local mr = re:match('\227\129\130\227\129\132')
  test.ok(mr)
  test.equal(mr:captureCount(), 0)
  test.equal(mr:first(0), 1)
